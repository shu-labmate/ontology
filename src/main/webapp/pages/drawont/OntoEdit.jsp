...
<body>
	<div class="container">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="mainOntAction_addOnt"
							role="form" id="ontInfoForm">
		...
		<form class="form-horizontal" action="mainOntAction_delOnt"
			role="form" id="ontInfoForm">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							&nbsp
							<button type="button" class="button btn-primary" id="delsubmit">确定</button>
						</div>
					</div>
				</div>
			</div>
