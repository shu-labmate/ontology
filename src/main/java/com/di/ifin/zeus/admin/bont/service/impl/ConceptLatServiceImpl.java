...
public class ConceptLatServiceImpl implements ConceptLatService {
	...
	/* (non-Javadoc)
	 * @see com.di.ifin.zeus.admin.bont.service.ConceptLatService#queryAll(java.lang.String, java.lang.String)
	 */
	@Override
	public List<ConceptLat> queryAll(String concept, String ontname) {
		return mongoTemplate.find(new Query(Criteria.where("ontname").is(ontname)), ConceptLat.class, concept);
	}
